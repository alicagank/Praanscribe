...
Also, you may cite it as:

`Kaya, A. Ç. (2026). Praanscribe: A semi-automatic, AI-powered segmentation tool for Praat (v1.0.0). Zenodo. https://doi.org/10.5281/zenodo.19896501`

or

`Kaya, A. Ç. (2025, May). Praanscribe: A semi-automatic, AI-powered segmentation tool for Praat [Poster presentation]. Student Conference on Linguistics 2025, Boğaziçi University, İstanbul, Türkiye.`
